            ...
            <div className="max-w-md w-full my-4 sm:my-0" onClick={e => e.stopPropagation()}>
                <Card className="p-6 sm:p-8">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        {view === 'register' && ({/* Updated conditional */ }
                            < div >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-gray-100 dark:bg-slate-700 border-gray-200 dark:border-slate-600 border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
                            autoComplete={view === 'login' ? "username" : "email"} {/* Updated conditional */}
                        />
                        {errors.email && <p className="text-red-500 text-xs mt-1">{errors.email.message}</p>}
                        {view === 'login' && <p className="text-xs text-slate-500 mt-1 text-center">Hint: Use 'pro@examredi.com' and any password for the Pro account.</p>} {/* Updated conditional */}
                    </div>

                    {view !== 'forgot' && ({/* Conditional rendering for password field */ }
                        < div >
                                ...
                                <div className="relative">
                                    <input
                                        {...registerField("password", {
                                            ...
                                            minLength: view === 'login' ? undefined : { value: 8, message: "Password must be at least 8 characters" } {/* Updated conditional */}
                                        })}
                                        id="password-modal"
                                        ...
                                        autoComplete={view === 'login' ? "current-password" : "new-password"} {/* Updated conditional */}
                                    />
                                    <button
                                        type="button"
