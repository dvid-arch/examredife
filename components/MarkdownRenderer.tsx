      ...
      components={{
        ...
        code({ node, className, children, ...props }: any) {
          ...
          if (language === 'solution') {
            return (
              <div className="bg-slate-900 border border-slate-700 p-5 rounded-xl my-8 text-slate-100 shadow-2xl overflow-x-auto">
                <div className="flex items-center gap-2 mb-4 border-b border-slate-800 pb-3 text-sm font-bold uppercase tracking-widest text-emerald-400">
